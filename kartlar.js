...
const TEPKI_KARTLARI = [
  {
    tepki: true, sure: 4,
    konusan: "Silahtar",
    metin: "Perde ardından bir hançer parıltısı — suikastçı üstüne atılıyor! Yanlış hamle canına mal olur.",
    a: { yazi: "Bileğini yakala, hançeri çevir", etki: { ordu: 8, halk: 6 } },
    b: { yazi: "Arkanı dönüp kaç", etki: {}, oldur: true },
    gecikme: { oldur: true },
  },
  {
    tepki: true, sure: 4,
    konusan: "Muhafız",
    metin: "Cuma selamlığında bir adam kalabalıktan fırladı, koynunda çelik parlıyor — sana koşuyor! Donup kalırsan geç olur.",
    a: { yazi: "Muhafızları öne geçir", etki: { ordu: 4, halk: -4 } },
    b: { yazi: "Atını mahmuzla, uzaklaş", etki: { halk: -4 } },
    gecikme: { oldur: true },
  },
  {
    tepki: true, sure: 5,
